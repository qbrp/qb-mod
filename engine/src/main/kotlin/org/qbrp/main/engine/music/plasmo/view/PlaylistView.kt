...
import org.qbrp.main.engine.music.plasmo.ClickableButton
...
class PlaylistView(
    ...
    var session: PlayerSession? = null) : View, KoinComponent {

    val storage: MusicStorage by inject()
    ...
    private fun getHeader(): Text {
        ...
        return try { Text.literal("")
            ...
            .append(" $cycleComponent  ".asMiniMessage())
    ...
    private fun getTracks(): Text {
        ...
        playable.queue.tracks.forEachIndexed { index, trackLine ->
            val track = storage.getTrackOrThrow(trackLine)
    ...
    private fun createTrackLine(index: Int, trackName: String, duration: String, loops: String): Text {
        ...
        return Text.literal("")
            .append(dot.asMiniMessage())
            .append(" ")
            .append((createClickableTrackButton(index, trackName)).toText())
            .append(" ")
            .append("($duration) $loops".asMiniMessage())
            .append(" ")
