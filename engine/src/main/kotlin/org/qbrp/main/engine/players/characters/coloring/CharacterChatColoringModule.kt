package org.qbrp.main.engine.players.characters.coloring
...
class CharacterChatColoringModule: ChatAddon("character-chat-coloring") {
    override fun onLoad() {
        ...
        MessageSendEvent.register() { sender, message, receiver, networking ->
            val player = PlayersUtil.getPlayerSession(message.authorName) ?: return@register ActionResult.PASS
            ...
            if (message.getTags().getComponentData<Boolean>("colorText") == true) {
                ...
                val config = getLocal<ServerConfigData>()
