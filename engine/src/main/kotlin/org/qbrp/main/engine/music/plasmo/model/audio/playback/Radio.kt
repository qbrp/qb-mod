...
import org.qbrp.main.engine.music.plasmo.model.audio.effects.ConditionalFadeInFilter
import org.qbrp.main.engine.music.plasmo.model.audio.effects.FadeOutFilter
import org.qbrp.main.engine.music.plasmo.playback.MusicFrameProvider
...
class Radio(
    ...
    companion object {
        val logger = LoggerUtil.get("musicManager", "controller")
    }
